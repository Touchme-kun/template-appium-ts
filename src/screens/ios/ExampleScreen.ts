/**
 * ExampleScreen - iOS sample screen template
 *
 * iOS version of ExampleScreen. Follows the same pattern as Android.
 * Replace locators with iOS-specific accessibility identifiers.
 *
